              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <div class="px-2 py-1 d-flex">
                      <div>
                        <img
                          src="https://source.unsplash.com/1280x720/?atlassian"
                          class="avatar avatar-sm me-2"
                          alt="logo_atlassian"
                        />
                      </div>
                ...
                <tr>
                  <td>
                    <div class="px-2 py-1 d-flex">
                      <div>
                        <img
                          src="https://source.unsplash.com/1280x720/?slack"
                          class="avatar avatar-sm me-2"
                          alt="logo_slack"
                        />
                      </div>
                ...
                <tr>
                  <td>
                    <div class="px-2 py-1 d-flex">
                      <div>
                        <img class="avatar avatar-sm me-2" alt="logo_spotify" />
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                ...
                <tr>
                  <td>
                    <div class="px-2 py-1 d-flex">
                      <div>
                        <img
                          src="https://source.unsplash.com/1280x720/?jira"
                          class="avatar avatar-sm me-2"
                          alt="logo_jira"
                        />
                      </div>

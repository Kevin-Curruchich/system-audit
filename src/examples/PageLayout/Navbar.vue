                  ...
                  <ul class="list-group">
                    ...
                    >
                      ...
                      >
                        <span>Sign In</span>
                        <!-- <img
                          src="https://source.unsplash.com/1280x720/?arrow"
                          alt="down-arrow"
                          class="arrow"
                        /> -->
                      </a>
...
export default {
  ...
  data() {
    return {
      downArrWhite: "https://source.unsplash.com/1280x720/?arrow",
      downArrBlack: "https://source.unsplash.com/1280x720/?arrow",
    };
  },
  computed: {
    darkModes() {
